...
def mensaje_logro(porcentaje_ float) -> str:
  if porcentaje == 100.0:
  ...
  return "Necesitas repasar mas para lograrlo, no te rindas, ANIMO!"
...
for i, p in enumerate(preguntas, start=1):
  print(f"Preguntas {i}/{cantidad_preguntas}: {p['enunciado']}")
